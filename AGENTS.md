...
- Add or update unit tests for every DTO validator and each validation rule in the same change as the validator.
- Cover valid DTOs, required fields, boundary values, cross-field constraints, and expected validation errors.
